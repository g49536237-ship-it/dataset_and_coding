...
grid_search = GridSearchCV(estimator=rf, param_grid=grid_params, cv=3, n_jobs=-1, verbose=1, scoring='r2')
...
plt.tight_layout()
plt.savefig(r"D:\pytharm\shijie\picture\RF-test_fit.png", dpi=600)
# 保存测试集拟合图像
# plt.savefig('D:/pytharm/person/regression forecasting/f0/RF-test_fit.png', dpi=600)
...
plt.grid(False)
plt.tight_layout()
plt.savefig(r"D:\pytharm\shijie\picture\RF-train_fit.png", dpi=600)
# 保存训练集拟合图像
# plt.savefig('D:/pytharm/person/regression forecasting/f0/RF-train_fit.png', dpi=600)
