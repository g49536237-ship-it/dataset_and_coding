...
param_grid = {
    ...
    'epsilon': [0.01, 0.06, 0.1, 0.2]
}
grid_search = GridSearchCV(SVR(kernel='rbf', tol=1e-3, max_iter=-1), param_grid, cv=5, scoring='neg_mean_squared_error', n_jobs=-1)
grid_search.fit(X_train, y_train)
print("最佳参数:", grid_search.best_params_)
print("最佳分数 (负MSE):", grid_search.best_score_)
...
# 保存测试集拟合图像
plt.savefig(r"D:\pytharm\shijie\picture\SVR-test_fit.png", dpi=600)
...
# 保存训练集拟合图像
plt.savefig(r"D:\pytharm\shijie\picture\SVR-train_fit.png", dpi=600)
